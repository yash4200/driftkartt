          ...
          {products.map((item) => (
            <div key={item._id} style={styles.card}>
              <div style={styles.imageBox}>
                {/* Asli Photo Logic using Unsplash */}
                <img
                  src={`https://source.unsplash.com/400x300/?${item.name.split(' ')[0]},grocery`}
                  alt={item.name}
                  style={styles.img}
                  onError={(e) => { e.target.src = "https://via.placeholder.com/400x300?text=Grocery" }}
                />
...
// --- Updated Styles for Premium Feel ---
const styles = {
